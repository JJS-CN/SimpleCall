...
public abstract class BaseActivity<P extends BasePersenter> extends AppCompatActivity implements IContract.IView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* if (mActivityOrientation != null) {
        ...
        if (hasResetActivityBackground) {
            ...
            mDecorView.setBackgroundColor(0xFFFFFFFF);
        }
        ...
        View titlebar = findViewById(R.id.cl_titlebar);
        if (titlebar != null) {
            titlebar.setBackgroundColor(mStatusBarColor);
    ...
    public void setTitle(int titleId) {
        ...
        View titleView = findViewById(R.id.tv_title);
        if (titleView != null && titleView instanceof TextView) {
            ((TextView) titleView).setText(titleId);
        }
    }
