...
public class WheelSnapHelper extends LinearSnapHelper {
     ...
     * @return
     */
    public WheelSnapHelper setWheelSize(@IntRange(from = 1) int wheelSize) {
  ...
  /*      ViewGroup.LayoutParams lp = recyclerView.getLayoutParams();
        lp.height = wheelSize * itemHalf - itemHalf;*/
            ...
            public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
                ...
                if (parent.getChildAdapterPosition(view) == 0) {
                    if (orientation == VERTICAL) {
                        outRect.top = (int) Math.ceil(parent.getHeight() / 2f - itemHalf * 0.9f);
                    } else {
                        outRect.left = (int) Math.ceil(parent.getWidth() / 2f - itemHalf * 0.9f);
                    }
                ...
                if (parent.getChildAdapterPosition(view) == state.getItemCount() - 1) {
                    if (orientation == VERTICAL) {
                        outRect.bottom = (int) Math.ceil(parent.getHeight() / 2f - itemHalf * 0.8f);
                    } else {
                        outRect.right = (int) Math.ceil(parent.getWidth() / 2f - itemHalf * 0.8f);
                    }
                }
            }
        });
